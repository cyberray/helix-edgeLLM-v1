...
# Download models during build (non-interactive, skip llama-3.2-3b-q4 due to 404)
RUN python -u download_models.py --download phi-3.5-mini-q4 qwen2.5-3b-q4 gemma-2-2b-q4
